...
def t161001000_1():
    ...
    t161001000_x6(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
...
def t161001000_2000():
    ...
    # eventflag:6001:Flag to always be ON
    # eventflag:6000:Flag to always be OFF
    assert (t161001000_x0(actionbutton1=6000, flag44=6001, flag48=6000, flag49=6000, flag50=6000, flag51=6000,
            flag43=6000))
    """State 1"""
    EndMachine(2000)
    Quit()

def t161001000_x0(actionbutton1=6000, flag44=6001, flag48=6000, flag49=6000, flag50=6000, flag51=6000, flag43=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t161001000_x4(val2=10, val3=12):
    """State 0,1"""
...
def t161001000_x6(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                  flag43=6000, flag44=6001, flag45=6000, flag46=6000, flag47=6000, z3=1, z4=1000000, z5=1000000,
                  z6=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t161001000_x23(flag40=flag40, flag41=flag41, flag42=flag42, val1=val1, val2=val2, val3=val3, val4=val4,
...
def t161001000_x7(val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000, flag43=6000, flag44=6001, flag45=6000,
                  flag46=6000, flag47=6000, z3=1, z4=1000000, z5=1000000, z6=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    while True:
        """State 2"""
        call = t161001000_x10(actionbutton1=actionbutton1, flag43=flag43, flag44=flag44, z4=z4, z5=z5, z6=z6)
        def WhilePaused():
        ...
        if call.Done():
            ...
            call = t161001000_x14(val1=val1, z3=z3)
            def WhilePaused():
        ...
        # eventflag:6000:Flag to always be OFF
            ...
            """State 6"""
            assert t161001000_x27() and CheckSpecificPersonTalkHasEnded(0)
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t161001000_x12(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t161001000_x8(val2=10, val3=12):
    """State 0,1"""
    call = t161001000_x18(val2=val2, val3=val3)
    assert IsPlayerDead()
    """State 2"""
    t161001000_x4(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t161001000_x9(flag40=6000, val2=10, val3=12):
    """State 0,8"""
    assert t161001000_x33()
    """State 1"""
    # eventflag:6000:Flag to always be OFF
...
def t161001000_x10(actionbutton1=6000, flag43=6000, flag44=6001, z4=1000000, z5=1000000, z6=1000000):
    """State 0,1"""
    call = t161001000_x11(machine1=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        # eventflag:6000:Flag to always be OFF
        assert (t161001000_x0(actionbutton1=actionbutton1, flag44=flag44, flag48=6000, flag49=6000, flag50=6000,
...
def t161001000_x11(machine1=_, val6=_):
    """State 0,1"""
...
def t161001000_x12(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t161001000_x1()
...
def t161001000_x13():
    """State 0,1"""
    assert t161001000_x11(machine1=1101, val6=1101)
    """State 2"""
    return 0

def t161001000_x14(val1=5, z3=1):
    """State 0,4"""
    assert t161001000_x24()
    """State 3"""
    call = t161001000_x15()
    def WhilePaused():
        SetTalkTime(1)
...
def t161001000_x15():
    """State 0,1"""
    assert t161001000_x11(machine1=1000, val6=1000)
    """State 2"""
    return 0

def t161001000_x16(val5=12):
    """State 0,2"""
    call = t161001000_x17()
    if call.Done():
        """State 1"""
        ...
        """State 3"""
        assert t161001000_x27()
    """State 4"""
    return 0

def t161001000_x17():
    """State 0,1"""
    assert t161001000_x11(machine1=1100, val6=1100)
    """State 2"""
    return 0

def t161001000_x18(val2=10, val3=12):
    """State 0,5"""
    assert t161001000_x33()
    """State 2"""
...
def t161001000_x19():
    """State 0,2"""
    call = t161001000_x11(machine1=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t161001000_x20():
    """State 0,1"""
    assert t161001000_x11(machine1=1001, val6=1001)
    """State 2"""
    return 0

def t161001000_x21():
    """State 0,1"""
    assert t161001000_x11(machine1=1103, val6=1103)
    """State 2"""
    return 0
...
def t161001000_x23(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                   flag43=6000, flag44=6001, flag45=6000, flag46=6000, flag47=6000, z3=1, z4=1000000, z5=1000000,
                   z6=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t161001000_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
        ...
        if CheckSelfDeath() or GetEventFlag(flag40):
            """State 3"""
            Label('L0')
            call = t161001000_x9(flag40=flag40, val2=val2, val3=val3)
            # eventflag:6000:Flag to always be OFF
        ...
        # eventflag:6000:Flag to always be OFF
            ...
            """State 2"""
            call = t161001000_x8(val2=val2, val3=val3)
            # eventflag:6000:Flag to always be OFF
            if CheckSelfDeath() or GetEventFlag(flag40):
                Goto('L0')
            # eventflag:6000:Flag to always be OFF
            ...
            pass
        """State 4"""
        assert t161001000_x32() and (not GetEventFlag(9000) and not IsPlayerDead())
    """Unused"""
    """State 5"""
    return 0
...
def t161001000_x24():
    """State 0,1"""
    assert t161001000_x25()
    """State 2"""
    return 0

def t161001000_x25():
    """State 0,1"""
    assert t161001000_x11(machine1=1104, val6=1104)
    """State 2"""
    return 0

def t161001000_x26():
    """State 0,1"""
    call = t161001000_x11(machine1=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t161001000_x5()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t161001000_x27():
    """State 0,1"""
    call = t161001000_x11(machine1=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t161001000_x5()
    elif call.Done():
...
def t161001000_x28():
    """State 0,1"""
    call = t161001000_x11(machine1=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t161001000_x5()
    elif call.Done():
...
def t161001000_x29():
    """State 0,1"""
    call = t161001000_x11(machine1=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t161001000_x5()
    elif call.Done():
...
def t161001000_x30(text1=_, flag1=_, mode7=1):
    """State 0,5"""
    assert t161001000_x2() and CheckSpecificPersonTalkHasEnded(0)
    """State 1"""
...
def t161001000_x31():
    """State 0,1"""
    assert t161001000_x11(machine1=1002, val6=1002)
    """State 2"""
    return 0
...
def t161001000_x34(z1=602, z2=3):
    """State 0,1"""
    c1_163(z1, z2)
    """State 2"""
    assert GetCurrentStateElapsedFrames() > 1
...
def t161001000_x36(text19=30900300, flag37=1209403, text20=30900400, flag38=1209404, text21=30914400, flag39=1209405):
    """State 0"""
    if not GetEventFlag(flag37):
        """State 2"""
        Label('L0')
        assert t161001000_x30(text1=text19, flag1=flag37, mode7=1)
    elif not GetEventFlag(flag38):
        """State 3"""
        assert t161001000_x30(text1=text20, flag1=flag38, mode7=1)
    elif not GetEventFlag(flag39):
        """State 4"""
        assert t161001000_x30(text1=text21, flag1=flag39, mode7=1)
    else:
        """State 1"""
...
def t161001000_x37(text15=30916800, flag29=1209410, text16=30915300, flag30=1209411, text17=30917200, flag31=1209412,
                   text18=_, flag32=_):
    """State 0"""
    if not GetEventFlag(flag29):
        """State 1"""
        assert t161001000_x30(text1=text15, flag1=flag29, mode7=1)
    elif not GetEventFlag(flag30):
        """State 2"""
        assert t161001000_x30(text1=text16, flag1=flag30, mode7=1)
    elif not GetEventFlag(flag31):
        """State 3"""
        assert t161001000_x30(text1=text17, flag1=flag31, mode7=1)
    elif not GetEventFlag(flag32):
        """State 4"""
        assert t161001000_x30(text1=text18, flag1=flag32, mode7=1)
    else:
        """State 5"""
        assert (t161001000_x39(text15=text15, flag33=-1, text16=text16, flag34=-1, text17=text17, flag35=-1, text18=text18,
                flag36=-1))
    """State 6"""
    return 0

def t161001000_x38(text9=30916800, flag17=1209410, text10=30915300, flag18=1209411, text11=30916200, flag19=1209413,
                   text12=30916300, flag20=1209414, text13=30916400, flag21=1209415, text14=_, flag22=_):
    """State 0"""
    if not GetEventFlag(flag17):
        """State 1"""
        assert t161001000_x30(text1=text9, flag1=flag17, mode7=1)
    elif not GetEventFlag(flag18):
        """State 2"""
        assert t161001000_x30(text1=text10, flag1=flag18, mode7=1)
    elif not GetEventFlag(flag19):
        """State 3"""
        assert t161001000_x30(text1=text11, flag1=flag19, mode7=1)
    elif not GetEventFlag(flag20):
        """State 4"""
        assert t161001000_x30(text1=text12, flag1=flag20, mode7=1)
    elif not GetEventFlag(flag21):
        """State 5"""
        assert t161001000_x30(text1=text13, flag1=flag21, mode7=1)
    elif not GetEventFlag(flag22):
        """State 7"""
        assert t161001000_x30(text1=text14, flag1=flag22, mode7=1)
    else:
        """State 6"""
        assert (t161001000_x40(text9=text9, flag23=-1, text10=text10, flag24=-1, text11=text11, flag25=-1, text12=text12,
                flag26=-1, text13=text13, flag27=-1, text14=text14, flag28=-1))
    """State 8"""
    return 0

def t161001000_x39(text15=30916800, flag33=-1, text16=30915300, flag34=-1, text17=30917200, flag35=-1, text18=_,
                   flag36=-1):
    """State 0,5"""
    assert t161001000_x3(z7=4)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t161001000_x30(text1=text15, flag1=flag33, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t161001000_x30(text1=text16, flag1=flag34, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t161001000_x30(text1=text17, flag1=flag35, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t161001000_x30(text1=text18, flag1=flag36, mode7=1)
    """State 7"""
    return 0

def t161001000_x40(text9=30916800, flag23=-1, text10=30915300, flag24=-1, text11=30916200, flag25=-1, text12=30916300,
                   flag26=-1, text13=30916400, flag27=-1, text14=_, flag28=-1):
    """State 0,5"""
    assert t161001000_x3(z7=6)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t161001000_x30(text1=text9, flag1=flag23, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t161001000_x30(text1=text10, flag1=flag24, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t161001000_x30(text1=text11, flag1=flag25, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t161001000_x30(text1=text12, flag1=flag26, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 4) == True:
        """State 7"""
        assert t161001000_x30(text1=text13, flag1=flag27, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 5) == True:
        """State 8"""
        assert t161001000_x30(text1=text14, flag1=flag28, mode7=1)
    """State 9"""
    return 0

def t161001000_x41(text1=30916800, flag9=-1, text2=30915300, flag10=-1, text3=30916300, flag11=-1, text4=30916400,
                   flag12=-1, text5=30916500, flag13=-1, text6=30916600, flag14=-1, text7=30916700, flag15=-1,
                   text8=_, flag16=-1):
    """State 0,5"""
    assert t161001000_x3(z7=8)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t161001000_x30(text1=text1, flag1=flag9, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t161001000_x30(text1=text2, flag1=flag10, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t161001000_x30(text1=text3, flag1=flag11, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t161001000_x30(text1=text4, flag1=flag12, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 4) == True:
        """State 7"""
        assert t161001000_x30(text1=text5, flag1=flag13, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 5) == True:
        """State 8"""
        assert t161001000_x30(text1=text6, flag1=flag14, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 6) == True:
        """State 9"""
        assert t161001000_x30(text1=text7, flag1=flag15, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 7) == True:
        """State 10"""
        assert t161001000_x30(text1=text8, flag1=flag16, mode7=1)
    """State 11"""
    return 0

def t161001000_x42(text1=30916800, flag1=1209410, text2=30915300, flag2=1209411, text3=30916300, flag3=1209414,
    ...
    if not GetEventFlag(flag1):
        """State 1"""
        assert t161001000_x30(text1=text1, flag1=flag1, mode7=1)
    elif not GetEventFlag(flag2):
        """State 2"""
        assert t161001000_x30(text1=text2, flag1=flag2, mode7=1)
    elif not GetEventFlag(flag3):
        """State 3"""
        assert t161001000_x30(text1=text3, flag1=flag3, mode7=1)
    elif not GetEventFlag(flag4):
        """State 4"""
        assert t161001000_x30(text1=text4, flag1=flag4, mode7=1)
    elif not GetEventFlag(flag5):
        """State 5"""
        assert t161001000_x30(text1=text5, flag1=flag5, mode7=1)
    elif not GetEventFlag(flag6):
        """State 6"""
        assert t161001000_x30(text1=text6, flag1=flag6, mode7=1)
    elif not GetEventFlag(flag7):
        """State 7"""
        assert t161001000_x30(text1=text7, flag1=flag7, mode7=1)
    elif not GetEventFlag(flag8):
        """State 8"""
        assert t161001000_x30(text1=text8, flag1=flag8, mode7=1)
    else:
        """State 9"""
        assert (t161001000_x41(text1=text1, flag9=-1, text2=text2, flag10=-1, text3=text3, flag11=-1, text4=text4,
...
def t161001000_x43():
    ...
    if GetEventFlag(10002400):
        ...
        assert t161001000_x30(text1=30900200, flag1=1209400, mode7=1)
    elif GetEventFlag(10002401):
        """State 2,6"""
        # talk:30914500:"How may I help you, champion?"
        assert t161001000_x30(text1=30914500, flag1=1209401, mode7=1)
    elif GetEventFlag(10002402):
        """State 3,7"""
        # talk:30914600:"No task is too great or small, champion!"
        assert t161001000_x30(text1=30914600, flag1=1209402, mode7=1)
    else:
        """State 4"""
        Goto('L0')
    """State 8"""
...
def t161001000_x44(mode1=0, mode2=0, mode3=1):
    """State 0,1"""
    ClearTalkListData()
...
def t161001000_x46():
    ...
    if GetTalkListEntryResult() == 96:
        ...
        assert t161001000_x30(text1=30900500, flag1=1209407, mode7=1)
    elif GetTalkListEntryResult() == 98:
        """State 6,9"""
        assert t161001000_x48()
        ...
        assert (t161001000_x36(text19=30900300, flag37=1209403, text20=30900400, flag38=1209404, text21=30914400,
                flag39=1209405))
...
def t161001000_x47(mode1=0, mode2=0, mode3=1):
    """State 0,1"""
    assert t161001000_x43()
    """State 3"""
    assert t161001000_x44(mode1=mode1, mode2=mode2, mode3=mode3)
    """State 4"""
    assert t161001000_x45()
    """State 2"""
    assert t161001000_x46()
    """State 5"""
    return 0
...
def t161001000_x49():
    ...
    assert t161001000_x30(text1=30900830, flag1=1209408, mode7=1)
    """State 2"""
    return 0
...
def t161001000_x50():
    ...
    if not GetEventFlag(1209406) and not GetChrHero() == Hero.Duchess:
        ...
        assert t161001000_x30(text1=30900100, flag1=1209406, mode7=1)
    # eventflag:6050: Skin release
        ...
        assert t161001000_x30(text1=30914700, flag1=1209409, mode7=1)
    else:
        """State 3,9"""
        return 0
    """State 10"""
...
def t161001000_x51():
    ...
    assert t161001000_x30(text1=30914800, flag1=1209427, mode7=1)
    """State 3"""
    SetEventFlag(1209428, FlagState.On)
    """State 1"""
    UnlockGarb(101000)
    """State 5"""
    assert t161001000_x35()
    """State 6"""
    return 0
...
def t161001000_x52():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        assert (t161001000_x37(text15=30916800, flag29=1209410, text16=30915300, flag30=1209411, text17=30917200,
...
def t161001000_x53():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        # talk:30915400:"My thanks for your continued help maintaining the armaments."
        # talk:30915401:"Once we have more, I implore you to continue."
        assert (t161001000_x38(text9=30916800, flag17=1209410, text10=30915300, flag18=1209411, text11=30916200,
...
def t161001000_x54():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        # talk:30915400:"My thanks for your continued help maintaining the armaments."
        # talk:30915401:"Once we have more, I implore you to continue."
        assert (t161001000_x42(text1=30916800, flag1=1209410, text2=30915300, flag2=1209411, text3=30916300, flag3=1209414,
...
def t161001000_x56():
    ...
    if f302(-1) == 1:
        ...
        if call.Get() == 1:
            ...
            """State 5"""
            Label('L1')
            assert t161001000_x47(mode1=0, mode2=0, mode3=1)
        elif call.Done():
            pass
    elif f302(-1) == 2:
        """State 4"""
...
def t161001000_x57():
    ...
    if GetEventFlag(3600):
        ...
        return 1
    """State 6"""
    assert t161001000_x58()
    """State 7"""
    return 0

def t161001000_x58():
    """State 0"""
    if not GetEventFlag(1169060):
        """State 1,3"""
        # talk:30911700:"Good to see you, brave champion."
        # talk:30911701:"Every one of you who has risen to challenge the Nightlord is most deserving of the title."
        # talk:30911702:"We are all equal, at the Roundtable. It is a place where all quibbles or grudges that came before are forgotten."
        # talk:30911703:"Do understand, there are those who would still rather keep their guard up around you for now..."
        # talk:30911704:"But I hope that won't be the case for long..."
        assert t161001000_x30(text1=30911700, flag1=1169060, mode7=1)
    elif GetEventFlag(1169060):
        """State 2,4"""
        # talk:30917100:"Yes, I, too, am a doll of sorts, you know."
        # talk:30917101:"Some might consider my care unseemly, but I am quite capable of seeing to everyone's needs here."
        # talk:30917102:"You, on the other hand, are an intricate work of beauty. Your creator was an artist, no doubt."
        assert t161001000_x30(text1=30917100, flag1=1169061, mode7=1)
    """State 5"""
    return 0
...
def t161001000_x59():
    ...
    """State 6"""
    Label('L2')
    # talk:30905400:"Oh, brave champion. What's happened?"
    # talk:30905401:"If I may ask. Do you have any idea whatsoever?"
    # talk:30905402:"Pools of black...intriguing..."
    # talk:30905403:"You tried to resist, but found yourself overcome?"
    # talk:30905404:"..."
    # talk:30905405:"None of the other champions have spoken of this, either."
    # talk:30905406:"Perhaps this is something that afflicts only you?"
    assert t161001000_x30(text1=30905400, flag1=1169062, mode7=1)
    Goto('L5')
    """State 7"""
    Label('L3')
    assert t161001000_x60()
    Goto('L5')
    """State 8"""
    Label('L4')
    # talk:30905610:"No one will notice a thing."
    # talk:30905611:"To use at your discretion."
    assert t161001000_x30(text1=30905610, flag1=1169065, mode7=1)
    """State 9"""
    Label('L5')
    return 0
...
def t161001000_x60():
    """State 0,4"""
    SetEventFlag(10003300, FlagState.On)
    """State 6"""
    # talk:30905500:"We certainly can't leave you looking like this."
    # talk:30905501:"Allow me to restore your beauty. Oh, don't worry, I'm an expert of sorts."
    assert t161001000_x30(text1=30905500, flag1=1169063, mode7=1)
    """State 1"""
    SetEventFlag(10003301, FlagState.On)
    """State 2"""
    assert not GetEventFlag(10003301)
    """State 7"""
    # talk:30905600:"There you are, all done."
    # talk:30905601:"No one will notice a thing."
    # talk:30905602:"Now, take this."
    # talk:30905603:"To use at your discretion."
    assert t161001000_x30(text1=30905600, flag1=1169064, mode7=1)
    """State 3"""
    UnlockGarb(108000)
    """State 8"""
    assert t161001000_x34(z1=602, z2=3)
    """State 5"""
    SetEventFlag(10003300, FlagState.Off)
    """State 9"""
    return 0
