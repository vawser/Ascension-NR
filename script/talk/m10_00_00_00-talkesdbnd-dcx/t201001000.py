...
def t201001000_1():
    ...
    t201001000_x6(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
...
def t201001000_1000():
    """State 0,2"""
    if GetEventFlag(10002406) and GetDistanceToPlayer() < 4:
        """State 4,11"""
        assert t201001000_x59()
    else:
        """State 5"""
        if GetCurrentScenarioSection() == 0:
            ...
            pass
        """State 3"""
        if f301(10) == 0 and f302(10) == 4:
            """State 10"""
            def WhilePaused():
                RequestAnimation(20026, -1)
            assert t201001000_x54()
        else:
            """State 8"""
            def WhilePaused():
                RequestAnimation(20026, -1)
            assert t201001000_x58()
    """State 1"""
    Label('L0')
    EndMachine(1000)
    Quit()
...
def t201001000_2000():
    ...
    # eventflag:6001:Flag to always be ON
    # eventflag:6000:Flag to always be OFF
    call = t201001000_x0(actionbutton1=6000, flag44=6001, flag48=6000, flag49=6000, flag50=6000, flag51=6000, flag43=6000)
    if call.Done():
        pass
    elif GetEventFlag(10002406) and GetDistanceToPlayer() < 4:
        """State 3"""
        pass
    """State 1"""
    EndMachine(2000)
...
def t201001000_x0(actionbutton1=6000, flag44=6001, flag48=6000, flag49=6000, flag50=6000, flag51=6000, flag43=6000):
    """State 0"""
    while True:
        """State 1"""
...
def t201001000_x4(val2=10, val3=12):
    """State 0,1"""
...
def t201001000_x6(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                  flag43=6000, flag44=6001, flag45=6000, flag46=6000, flag47=6000, z1=1, z2=1000000, z3=1000000,
                  z4=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    ...
    while True:
        """State 2"""
        call = t201001000_x23(flag40=flag40, flag41=flag41, flag42=flag42, val1=val1, val2=val2, val3=val3, val4=val4,
...
def t201001000_x7(val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000, flag43=6000, flag44=6001, flag45=6000,
                  flag46=6000, flag47=6000, z1=1, z2=1000000, z3=1000000, z4=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    while True:
        """State 2"""
        call = t201001000_x10(actionbutton1=actionbutton1, flag43=flag43, flag44=flag44, z2=z2, z3=z3, z4=z4)
        def WhilePaused():
        ...
        if call.Done():
            ...
            call = t201001000_x14(val1=val1, z1=z1)
            def WhilePaused():
        ...
        # eventflag:6000:Flag to always be OFF
            ...
            """State 6"""
            assert t201001000_x27() and CheckSpecificPersonTalkHasEnded(0)
            continue
        ...
        def ExitPause():
            RemoveMyAggro()
        assert t201001000_x12(val2=val2, val3=val3)
    """Unused"""
    """State 7"""
    return 0

def t201001000_x8(val2=10, val3=12):
    """State 0,1"""
    call = t201001000_x18(val2=val2, val3=val3)
    assert IsPlayerDead()
    """State 2"""
    t201001000_x4(val2=val2, val3=val3)
    Quit()
    """Unused"""
    """State 3"""
    return 0

def t201001000_x9(flag40=6000, val2=10, val3=12):
    """State 0,8"""
    assert t201001000_x33()
    """State 1"""
    # eventflag:6000:Flag to always be OFF
...
def t201001000_x10(actionbutton1=6000, flag43=6000, flag44=6001, z2=1000000, z3=1000000, z4=1000000):
    """State 0,1"""
    call = t201001000_x11(machine1=2000, val6=2000)
    if call.Get() == 1:
        """State 2"""
        # eventflag:6000:Flag to always be OFF
        assert (t201001000_x0(actionbutton1=actionbutton1, flag44=flag44, flag48=6000, flag49=6000, flag50=6000,
...
def t201001000_x11(machine1=_, val6=_):
    """State 0,1"""
...
def t201001000_x12(val2=10, val3=12):
    """State 0"""
    assert GetCurrentStateElapsedFrames() > 1
    """State 5"""
    assert t201001000_x1()
...
def t201001000_x13():
    """State 0,1"""
    assert t201001000_x11(machine1=1101, val6=1101)
    """State 2"""
    return 0

def t201001000_x14(val1=5, z1=1):
    """State 0,4"""
    assert t201001000_x24()
    """State 3"""
    call = t201001000_x15()
    def WhilePaused():
        SetTalkTime(1)
...
def t201001000_x15():
    """State 0,1"""
    assert t201001000_x11(machine1=1000, val6=1000)
    """State 2"""
    return 0

def t201001000_x16(val5=12):
    """State 0,2"""
    call = t201001000_x17()
    if call.Done():
        """State 1"""
        ...
        """State 3"""
        assert t201001000_x27()
    """State 4"""
    return 0

def t201001000_x17():
    """State 0,1"""
    assert t201001000_x11(machine1=1100, val6=1100)
    """State 2"""
    return 0

def t201001000_x18(val2=10, val3=12):
    """State 0,5"""
    assert t201001000_x33()
    """State 2"""
...
def t201001000_x19():
    """State 0,2"""
    call = t201001000_x11(machine1=1102, val6=1102)
    if call.Get() == 1:
        """State 1"""
        Quit()
    elif call.Done():
...
def t201001000_x20():
    """State 0,1"""
    assert t201001000_x11(machine1=1001, val6=1001)
    """State 2"""
    return 0

def t201001000_x21():
    """State 0,1"""
    assert t201001000_x11(machine1=1103, val6=1103)
    """State 2"""
    return 0
...
def t201001000_x23(flag40=6000, flag41=6000, flag42=6000, val1=5, val2=10, val3=12, val4=10, val5=12, actionbutton1=6000,
                   flag43=6000, flag44=6001, flag45=6000, flag46=6000, flag47=6000, z1=1, z2=1000000, z3=1000000,
                   z4=1000000, mode4=1, mode5=1, mode6=1):
    """State 0"""
    while True:
        """State 1"""
        RemoveMyAggro()
        call = t201001000_x7(val1=val1, val2=val2, val3=val3, val4=val4, val5=val5, actionbutton1=actionbutton1,
        ...
        if CheckSelfDeath() or GetEventFlag(flag40):
            """State 3"""
            Label('L0')
            call = t201001000_x9(flag40=flag40, val2=val2, val3=val3)
            # eventflag:6000:Flag to always be OFF
        ...
        # eventflag:6000:Flag to always be OFF
            ...
            """State 2"""
            call = t201001000_x8(val2=val2, val3=val3)
            # eventflag:6000:Flag to always be OFF
            if CheckSelfDeath() or GetEventFlag(flag40):
                Goto('L0')
            # eventflag:6000:Flag to always be OFF
            ...
            pass
        """State 4"""
        assert t201001000_x32() and (not GetEventFlag(9000) and not IsPlayerDead())
    """Unused"""
    """State 5"""
    return 0
...
def t201001000_x24():
    """State 0,1"""
    assert t201001000_x25()
    """State 2"""
    return 0

def t201001000_x25():
    """State 0,1"""
    assert t201001000_x11(machine1=1104, val6=1104)
    """State 2"""
    return 0

def t201001000_x26():
    """State 0,1"""
    call = t201001000_x11(machine1=1201, val6=1201)
    if call.Get() == 1:
        """State 2"""
        assert t201001000_x5()
    elif call.Done():
        pass
    """State 3"""
    return 0
...
def t201001000_x27():
    """State 0,1"""
    call = t201001000_x11(machine1=1300, val6=1300)
    if call.Get() == 1:
        """State 2"""
        assert t201001000_x5()
    elif call.Done():
...
def t201001000_x28():
    """State 0,1"""
    call = t201001000_x11(machine1=1301, val6=1301)
    if call.Get() == 1:
        """State 2"""
        assert t201001000_x5()
    elif call.Done():
...
def t201001000_x29():
    """State 0,1"""
    call = t201001000_x11(machine1=1302, val6=1302)
    if call.Get() == 1:
        """State 2"""
        assert t201001000_x5()
    elif call.Done():
...
def t201001000_x30(text1=_, flag1=_, mode7=1):
    """State 0,5"""
    assert t201001000_x2() and CheckSpecificPersonTalkHasEnded(0)
    """State 1"""
...
def t201001000_x31():
    """State 0,1"""
    assert t201001000_x11(machine1=1002, val6=1002)
    """State 2"""
    return 0
...
def t201001000_x35(text19=30900300, flag37=1209403, text20=30900400, flag38=1209404, text21=30914400, flag39=1209405):
    """State 0"""
    if not GetEventFlag(flag37):
        """State 2"""
        Label('L0')
        assert t201001000_x30(text1=text19, flag1=flag37, mode7=1)
    elif not GetEventFlag(flag38):
        """State 3"""
        assert t201001000_x30(text1=text20, flag1=flag38, mode7=1)
    elif not GetEventFlag(flag39):
        """State 4"""
        assert t201001000_x30(text1=text21, flag1=flag39, mode7=1)
    else:
        """State 1"""
...
def t201001000_x36(text15=30916800, flag29=1209410, text16=30915300, flag30=1209411, text17=30917200, flag31=1209412,
                   text18=_, flag32=_):
    """State 0"""
    if not GetEventFlag(flag29):
        """State 1"""
        assert t201001000_x30(text1=text15, flag1=flag29, mode7=1)
    elif not GetEventFlag(flag30):
        """State 2"""
        assert t201001000_x30(text1=text16, flag1=flag30, mode7=1)
    elif not GetEventFlag(flag31):
        """State 3"""
        assert t201001000_x30(text1=text17, flag1=flag31, mode7=1)
    elif not GetEventFlag(flag32):
        """State 4"""
        assert t201001000_x30(text1=text18, flag1=flag32, mode7=1)
    else:
        """State 5"""
        assert (t201001000_x38(text15=text15, flag33=-1, text16=text16, flag34=-1, text17=text17, flag35=-1, text18=text18,
                flag36=-1))
    """State 6"""
    return 0

def t201001000_x37(text9=30916800, flag17=1209410, text10=30915300, flag18=1209411, text11=30916200, flag19=1209413,
                   text12=30916300, flag20=1209414, text13=30916400, flag21=1209415, text14=_, flag22=_):
    """State 0"""
    if not GetEventFlag(flag17):
        """State 1"""
        assert t201001000_x30(text1=text9, flag1=flag17, mode7=1)
    elif not GetEventFlag(flag18):
        """State 2"""
        assert t201001000_x30(text1=text10, flag1=flag18, mode7=1)
    elif not GetEventFlag(flag19):
        """State 3"""
        assert t201001000_x30(text1=text11, flag1=flag19, mode7=1)
    elif not GetEventFlag(flag20):
        """State 4"""
        assert t201001000_x30(text1=text12, flag1=flag20, mode7=1)
    elif not GetEventFlag(flag21):
        """State 5"""
        assert t201001000_x30(text1=text13, flag1=flag21, mode7=1)
    elif not GetEventFlag(flag22):
        """State 7"""
        assert t201001000_x30(text1=text14, flag1=flag22, mode7=1)
    else:
        """State 6"""
        assert (t201001000_x39(text9=text9, flag23=-1, text10=text10, flag24=-1, text11=text11, flag25=-1, text12=text12,
                flag26=-1, text13=text13, flag27=-1, text14=text14, flag28=-1))
    """State 8"""
    return 0

def t201001000_x38(text15=30916800, flag33=-1, text16=30915300, flag34=-1, text17=30917200, flag35=-1, text18=_,
                   flag36=-1):
    """State 0,5"""
    assert t201001000_x3(z5=4)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t201001000_x30(text1=text15, flag1=flag33, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t201001000_x30(text1=text16, flag1=flag34, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t201001000_x30(text1=text17, flag1=flag35, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t201001000_x30(text1=text18, flag1=flag36, mode7=1)
    """State 7"""
    return 0

def t201001000_x39(text9=30916800, flag23=-1, text10=30915300, flag24=-1, text11=30916200, flag25=-1, text12=30916300,
                   flag26=-1, text13=30916400, flag27=-1, text14=_, flag28=-1):
    """State 0,5"""
    assert t201001000_x3(z5=6)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t201001000_x30(text1=text9, flag1=flag23, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t201001000_x30(text1=text10, flag1=flag24, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t201001000_x30(text1=text11, flag1=flag25, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t201001000_x30(text1=text12, flag1=flag26, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 4) == True:
        """State 7"""
        assert t201001000_x30(text1=text13, flag1=flag27, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 5) == True:
        """State 8"""
        assert t201001000_x30(text1=text14, flag1=flag28, mode7=1)
    """State 9"""
    return 0

def t201001000_x40(text1=30916800, flag9=-1, text2=30915300, flag10=-1, text3=30916300, flag11=-1, text4=30916400,
                   flag12=-1, text5=30916500, flag13=-1, text6=30916600, flag14=-1, text7=30916700, flag15=-1,
                   text8=_, flag16=-1):
    """State 0,5"""
    assert t201001000_x3(z5=8)
    """State 1"""
    if CompareRNGValue(CompareType.Equal, 0) == True:
        """State 2"""
        assert t201001000_x30(text1=text1, flag1=flag9, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 1) == True:
        """State 3"""
        assert t201001000_x30(text1=text2, flag1=flag10, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 2) == True:
        """State 4"""
        assert t201001000_x30(text1=text3, flag1=flag11, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 3) == True:
        """State 6"""
        assert t201001000_x30(text1=text4, flag1=flag12, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 4) == True:
        """State 7"""
        assert t201001000_x30(text1=text5, flag1=flag13, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 5) == True:
        """State 8"""
        assert t201001000_x30(text1=text6, flag1=flag14, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 6) == True:
        """State 9"""
        assert t201001000_x30(text1=text7, flag1=flag15, mode7=1)
    elif CompareRNGValue(CompareType.Equal, 7) == True:
        """State 10"""
        assert t201001000_x30(text1=text8, flag1=flag16, mode7=1)
    """State 11"""
    return 0

def t201001000_x41(text1=30916800, flag1=1209410, text2=30915300, flag2=1209411, text3=30916300, flag3=1209414,
    ...
    if not GetEventFlag(flag1):
        """State 1"""
        assert t201001000_x30(text1=text1, flag1=flag1, mode7=1)
    elif not GetEventFlag(flag2):
        """State 2"""
        assert t201001000_x30(text1=text2, flag1=flag2, mode7=1)
    elif not GetEventFlag(flag3):
        """State 3"""
        assert t201001000_x30(text1=text3, flag1=flag3, mode7=1)
    elif not GetEventFlag(flag4):
        """State 4"""
        assert t201001000_x30(text1=text4, flag1=flag4, mode7=1)
    elif not GetEventFlag(flag5):
        """State 5"""
        assert t201001000_x30(text1=text5, flag1=flag5, mode7=1)
    elif not GetEventFlag(flag6):
        """State 6"""
        assert t201001000_x30(text1=text6, flag1=flag6, mode7=1)
    elif not GetEventFlag(flag7):
        """State 7"""
        assert t201001000_x30(text1=text7, flag1=flag7, mode7=1)
    elif not GetEventFlag(flag8):
        """State 8"""
        assert t201001000_x30(text1=text8, flag1=flag8, mode7=1)
    else:
        """State 9"""
        assert (t201001000_x40(text1=text1, flag9=-1, text2=text2, flag10=-1, text3=text3, flag11=-1, text4=text4,
...
def t201001000_x42():
    ...
    if GetEventFlag(10002400):
        ...
        assert t201001000_x30(text1=30900200, flag1=1209400, mode7=1)
    elif GetEventFlag(10002401):
        """State 2,6"""
        # talk:30914500:"How may I help you, champion?"
        assert t201001000_x30(text1=30914500, flag1=1209401, mode7=1)
    elif GetEventFlag(10002402):
        """State 3,7"""
        # talk:30914600:"No task is too great or small, champion!"
        assert t201001000_x30(text1=30914600, flag1=1209402, mode7=1)
    else:
        """State 4"""
        Goto('L0')
    """State 8"""
...
def t201001000_x43(mode1=_, mode2=1, mode3=1):
    """State 0,1"""
    ClearTalkListData()
...
def t201001000_x45():
    ...
    if GetTalkListEntryResult() == 96:
        ...
        assert t201001000_x30(text1=30900500, flag1=1209407, mode7=1)
    elif GetTalkListEntryResult() == 98:
        """State 6,9"""
        assert t201001000_x47()
        ...
        assert (t201001000_x35(text19=30900300, flag37=1209403, text20=30900400, flag38=1209404, text21=30914400,
                flag39=1209405))
...
def t201001000_x46(mode1=1, mode2=1, mode3=1):
    """State 0,1"""
    assert t201001000_x42()
    """State 3"""
    assert t201001000_x43(mode1=mode1, mode2=mode2, mode3=mode3)
    """State 4"""
    assert t201001000_x44()
    """State 2"""
    assert t201001000_x45()
    """State 5"""
    return 0
...
def t201001000_x48():
    ...
    assert t201001000_x30(text1=30900830, flag1=1209408, mode7=1)
    """State 2"""
    return 0
...
def t201001000_x49():
    ...
    if not GetEventFlag(1209406) and not GetChrHero() == Hero.Duchess:
        ...
        assert t201001000_x30(text1=30900100, flag1=1209406, mode7=1)
    # eventflag:6050: Skin release
        ...
        assert t201001000_x30(text1=30914700, flag1=1209409, mode7=1)
    else:
        """State 3,9"""
        return 0
    """State 10"""
...
def t201001000_x50():
    ...
    assert t201001000_x30(text1=30914800, flag1=1209427, mode7=1)
    """State 3"""
    SetEventFlag(1209428, FlagState.On)
    """State 1"""
    UnlockGarb(101000)
    """State 5"""
    assert t201001000_x34()
    """State 6"""
    return 0
...
def t201001000_x51():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        assert (t201001000_x36(text15=30916800, flag29=1209410, text16=30915300, flag30=1209411, text17=30917200,
...
def t201001000_x52():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        # talk:30915400:"My thanks for your continued help maintaining the armaments."
        # talk:30915401:"Once we have more, I implore you to continue."
        assert (t201001000_x37(text9=30916800, flag17=1209410, text10=30915300, flag18=1209411, text11=30916200,
...
def t201001000_x53():
    ...
    if GetChrHero() == Hero.Wylder:
        ...
        # talk:30915400:"My thanks for your continued help maintaining the armaments."
        # talk:30915401:"Once we have more, I implore you to continue."
        assert (t201001000_x41(text1=30916800, flag1=1209410, text2=30915300, flag2=1209411, text3=30916300, flag3=1209414,
...
def t201001000_x55():
    ...
    if f302(-1) == 4:
        """State 2"""
        assert t201001000_x56()
    else:
        """State 1,3"""
        assert t201001000_x46(mode1=1, mode2=1, mode3=1)
    """State 4"""
    return 0

def t201001000_x56():
    """State 0,1,2"""
    assert t201001000_x57()
    """State 3"""
    return 0
...
def t201001000_x57():
    ...
    assert t201001000_x42()
    """State 6"""
    assert t201001000_x43(mode1=0, mode2=1, mode3=1)
    """State 1"""
    # action:23090002:"About this place..."
    AddTalkListDataAlt(96, 23090002, -1, 0, False)
    """State 7"""
    assert t201001000_x44()
    """State 2"""
    if GetTalkListEntryResult() == 96:
        """State 3,9"""
        # talk:30900800:"It appears you have unearthed some old history."
        # talk:30900801:"Yes, the crypt is filled with the ancient people of these lands."
        # talk:30900802:"I still remember looking after them, long, long ago."
        # talk:30900803:"As you know, mortality does not apply to those such as myself."
        # talk:30900804:"These souls were laid to rest here in anticipation of the threat we now face."
        # talk:30900805:"In a ritual required to draw the minds of their descendants here."
        assert t201001000_x30(text1=30900800, flag1=1209408, mode7=1)
        """State 4"""
...
def t201001000_x59():
    ...
    # talk:30914701:"I have installed a dressing room next to the study."
    # talk:30914702:"If you have other garments you would prefer to don, it is yours to use as you will."
    call = t201001000_x30(text1=30914700, flag1=1209409, mode7=1)
    if call.Done():
        pass
    elif GetDistanceToPlayer() > 4.1:
        """State 1,4"""
        assert t201001000_x1()
    """State 2"""
    SetEventFlag(10002406, FlagState.Off)
    """State 5"""
    return 0
