...
def t607001000_x0(actionbutton1=6905, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=10003045):
    """State 0"""
    while True:
        """State 1"""
        ...
        if (GetEventFlag(flag6) or not (not GetOneLineHelpStatus() and not IsPlayerDead() and not IsCharacterDisabled())
            ...
            pass
        # actionbutton:6905:"Change sparring equipment"
...
def t607001000_x2():
    ...
    while True:
        ...
        # eventflag:6001:Flag to always be ON
        # eventflag:6000:Flag to always be OFF
        assert t607001000_x0(actionbutton1=6905, flag1=6001, flag2=6000, flag3=6000, flag4=6000, flag5=6000, flag6=10003045)
        """State 1,6"""
        call = t607001000_x3()
        if call.Done() and not (CheckSpecificPersonMenuIsOpen(40, 0) and not CheckSpecificPersonGenericDialogIsOpen(0)):
            """State 2"""
            pass
        elif GetDistanceToPlayer() > 7:
            """State 3,5"""
            assert t607001000_x1()
    """Unused"""
    """State 7"""
    return 0
...
def t607001000_x3():
    """State 0,1"""
    OpenSparringEquipmentMenu()
    assert not (CheckSpecificPersonMenuIsOpen(40, 0) and not CheckSpecificPersonGenericDialogIsOpen(0))
    """State 2,3"""
    return 0
